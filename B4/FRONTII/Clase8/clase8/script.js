const noticias = [
  ...
  },
  {
    ...
    descripcion:
      "El objetivo es ayudar a los países a emprender latransición ecológica en su camino hacia una economía libre de emisiones de gases de efecto invernadero a mitad de siglo",
    fecha: "04/06/21",
    tipoNacional: false,
  },
  {
...
function renderizarNoticias() {
  for (const noticia of noticias) {
      debugger
    main.innerHTML += `<div class="noticia ${
      noticia.tipoNacional ? 'nacional' : ''
    }>
